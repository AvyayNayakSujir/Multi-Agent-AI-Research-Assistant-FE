...
export function StatusProgress({ steps, isLoading }: StatusProgressProps) {
  ...
  return (
    <div className="my-4 rounded-xl border border-zinc-200 bg-zinc-50 p-4 transition-all dark:border-zinc-800 dark:bg-zinc-900/40">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-semibold text-zinc-700 dark:text-zinc-300">
            {isLoading ? currentStep.message : 'Research complete'}
          </span>
        </div>
        <button
